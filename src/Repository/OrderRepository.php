...
class OrderRepository extends ServiceEntityRepository
{
    ...
    public function countFilteredOrders(?\DateTimeInterface $startDate, ?\DateTimeInterface $endDate): int
{
    $qb = $this->createQueryBuilder('o')
        ->select('COUNT(o.id)');
    ...
    public function findFilteredPaginatedOrders(?\DateTimeInterface $startDate, ?\DateTimeInterface $endDate, int $limit, int $offset): array
    {
        $qb = $this->createQueryBuilder('o')
            ->orderBy('o.createdAt', 'DESC')
            ->setMaxResults($limit)
